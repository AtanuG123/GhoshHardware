      ...
      <section className="bg-blue-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-2xl mx-auto">
            Get in touch with our team for equipment inquiries, technical support, and expert guidance.
          </p>
        </div>
      </section>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      info@bengalfisheryhardware.com<br />
                      support@bengalfisheryhardware.com
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-8 p-4 bg-blue-50 rounded-lg">
                ...
                <p className="text-sm text-blue-700">
                  Our technical team is available for equipment installation guidance and 
                  troubleshooting support during business hours.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="h-96 bg-gray-200 flex items-center justify-center">
              <div className="text-center text-gray-500">
                ...
                <p className="text-sm">456 Hardware Market Street, Kolkata, West Bengal 700001</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <p className="text-gray-600 text-sm">
              Get free consultation on equipment selection and installation from our technical experts.
            </p>
          </div>
